        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-lg-4 pull-right">
                    ...
                    <form method="post" action="{{route('student.login-code')}}" onsubmit="return validate()" name="f1" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-email">
                                <input type="email" class="err" name="username" id="username" placeholder="Username">
                            </div>
                            ...
                            <div class="form-check">
                                ...
                                Remember me</label> -->
                                <a href="{{ route('student.forgot-password') }}">Forget password?</a>
                            </div>

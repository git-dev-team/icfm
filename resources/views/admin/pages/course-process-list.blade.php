    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-4 col-7">
                <h4 class="page-title">Course Process List ( {{ count($list) }} )
                </h4>
            </div>
            <div class="col-sm-8 col-5 text-right m-b-20">
                <a href="{{ route('admin.course.process.create') }}" class="btn btn-primary float-right btn-rounded"><i
                        class="fa fa-plus"></i> Add Course Process</a>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            foreach ($list as $lists) { ?>
                                <tr>
                                    ...
                                    <td>{{ $lists->title }}</td>
                                    <td><i class="fa {{ $lists->icon }} h2"></i></td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href="{{ route('admin.course.process.edit',['id'=>$lists->id]) }}"><i
                                                class="fa fa-pencil-square-o f-16 mr-7 text-green"></i></a>
                                        <a href="#"><i onclick="del('{{ route('admin.course.process.delete',['id'=>$lists->id]) }}')"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Course Process Information</h4>
...
<script type="text/javascript">
    ...
    function load_marks(id) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('admin.course.process.details') }}",
            data: {
            ...
            success: function (data) {
                ...
                '<tr><th scope="row">Icon:</th><td><i class="fa '+data.icon+' h2"></i></td></tr>'+

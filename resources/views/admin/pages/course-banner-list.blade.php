    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-4 col-7">
                <h4 class="page-title">Course Banner List ( {{ count($list) }} )
                </h4>
            </div>
            <div class="col-sm-8 col-5 text-right m-b-20">
                <a href="{{ route('admin.course.banner.create') }}" class="btn btn-primary float-right btn-rounded"><i
                        class="fa fa-plus"></i> Add Course Banner</a>
            </div>
        </div>
                            ...
                            foreach ($list as $lists) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href="{{ route('admin.course.banner.edit',['id'=>$lists->id]) }}"><i
                                                class="fa fa-pencil-square-o f-16 mr-7 text-green"></i></a>
                                        <a href="#"><i onclick="del('{{ route('admin.course.banner.delete',['id'=>$lists->id]) }}')"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Course Banner Information</h4>
...
<script type="text/javascript">
    ...
    function load_marks(id) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('admin.banner.details') }}",
            data: {
                _token: $('meta[name="csrf-token"]').attr('content'),
                id: id,
            },
            success: function (data) {
                var details = '<tr><th scope="row">Title:</th><td>'+data.title+'</td></tr>'+

    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-4 col-7">
                ...
                <h4 class="page-title">Edit Course Banner</h4>
                <?php } else { ?>
                <h4 class="page-title">Add Course Banner</h4>
                <?php } ?>
            </div>
            <div class="col-sm-8 col-5 text-right m-b-20">
                <a href="{{ route('admin.course.banner') }}" class="btn btn-primary float-right btn-rounded">Course Banner
                    List</a>
            </div>
        </div>
       @include('admin.common.flash-message')
        <div class="row">
            <div class="col-lg-12">
                <div class="bgr_stse">
                    <form method="post" action="{{ route('admin.course.banner.save') }}" enctype='multipart/form-data'
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="category" id="type"
                                        ...
                                        @foreach($course as $c_row)
                                        <option value="{{ $c_row->id }}" <?php if (isset($details)) {
                                            if ($details->category == $c_row->id) {
                                                echo 'selected';
                                            }
                                        } ?>>{{ $c_row->title }} [ {{ $c_row->course_code }} ]</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="m-t-20 text-center">
                            <?php if (isset($details)) { ?>
                            <button class="btn btn-primary submit-btn" type="submit">Update Course Banner</button>
                            <?php } else { ?>
                            <button class="btn btn-primary submit-btn" type="submit">Add Course Banner</button>
                            <?php } ?>
                        </div>
                    </form>
                </div>

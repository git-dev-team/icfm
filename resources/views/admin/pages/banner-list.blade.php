    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-4 col-7">
                <h4 class="page-title">Banner List ( {{ count($list) }} )
                </h4>
            </div>
            <div class="col-sm-8 col-5 text-right m-b-20">
                <a href="{{ route('admin.banner.create') }}" class="btn btn-primary float-right btn-rounded"><i
                    ...
                    <table class="display" style="width:100%" id="application_table">
                        ...
                        <tbody>
                            ...
                            foreach ($list as $lists) {
                                ...
                                <tr>
                                    <td> {{ $i++ }}</td>
                                    <td>{{ ucwords(str_replace("-", " ", $lists->category)) }}</td>
                                    <td>{{ $lists->title }}</td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href="{{ route('admin.banner.edit',['id'=>$lists->id]) }}"><i
                                                class="fa fa-pencil-square-o f-16 mr-7 text-green"></i></a>
                                        <a href="#"><i onclick="del('{{ route('admin.banner.delete',['id'=>$lists->id]) }}')"

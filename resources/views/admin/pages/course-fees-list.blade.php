    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-4 col-7">
                <h4 class="page-title">Course Fees List ( {{ count($list) }} )</h4>
            </div>
            <div class="col-sm-8 col-5 text-right m-b-20">
                <a href="{{ route('admin.course.fees.create') }}" class="btn btn-primary float-right btn-rounded"><i
                        class="fa fa-plus"></i> Add Course Fees</a>
            </div>
        </div>
                            ...
                            foreach ($list as $lists) { ?>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href="{{ route('admin.course.fees.edit',['id'=>$lists->id]) }}"><i
                                                class="fa fa-pencil-square-o f-16 mr-7 text-green"></i></a>
                                        <a href="#"><i onclick="del('{{ route('admin.course.fees.delete',['id'=>$lists->id]) }}')"
